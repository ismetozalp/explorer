...
const c = A._aiParseHead(claudeHead, 'fallback', false);
...
assert.strictEqual(A._aiParseHead(claudeArr, 'fb', false).title, 'hello there');
...
const x = A._aiParseHead(codexHead, 'fallback', false);
...
const tr = A._aiParseHead(truncated, 'fb', true);
